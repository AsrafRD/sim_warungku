      ...
      <main className="relative z-10 mx-auto flex w-full max-w-md flex-1 flex-col px-5 pb-5 pt-8 sm:px-6 sm:pt-20">
        ...
        <div className="mb-5 text-center text-white animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="mx-auto max-w-[300px] text-base font-medium leading-relaxed text-white/85">
            Sistem kasir & manajemen stok modern untuk mengelola warung Anda.
          </p>
        ...
        <div className="mb-8 space-y-3 animate-in fade-in slide-in-from-bottom-8 delay-150 duration-700 fill-mode-both">
          ...
          <FeatureCard
            ...
            description="Kelola banyak toko dengan pencatatan stok secara real-time."
          ...
          <FeatureCard
            ...
            description="Cetak struk langsung dari browser dengan printer thermal."
        ...
        <div className="mb-8 flex items-center justify-center gap-5 text-xs font-medium text-slate-500">
